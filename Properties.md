The Properties tab of the [Database Object Editor](https://github.com/serge-rider/dbeaver/wiki/Database-Object-Editor) provides tools to view and edit the object`s properties. 
...
The sub-entities appear each in its own view – to open such a view, click the tabs on the left side of the area.

The toolbar at the bottom of the tab provides the following tools for the majority of sub-entities except for some specific ones like Permissions (in PostreSQL) or SQL based views (DDL and Source):
