Query Manager is a view that shows the history of all SQL queries that DBeaver has executed during the current session. To open the Query Manager, do one of the following:
